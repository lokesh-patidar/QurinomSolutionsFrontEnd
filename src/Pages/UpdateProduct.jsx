...
import { getProductByIdFunc, updateProductFunc } from '../ReduxToolkit/Products/productsActions';
...
const UpdateProduct = ({ id }) => {
     ...
     const handleSubmit = (event) => {
          ...
          if (formData) {
               ...
               dispatch(updateProductFunc(id, formData, navigate, onClose, resetFormData, setLoad));
          }
          else {
     ...
     return (
          <>
               <Button size={'sm'} onClick={handleClick} color='green' mr={3} leftIcon={<EditIcon color='green' />}>Update</Button>
               <Modal
